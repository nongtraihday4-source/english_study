  ...
  <div class="flex h-screen overflow-hidden" style="background-color: var(--color-surface)">
    ...
    >
      ...
      <div class="flex items-center gap-3 px-4 h-16 shrink-0 border-b" style="border-color: var(--color-surface-04)">
        ...
        <span v-if="!collapsed" class="font-bold text-sm truncate" style="color: var(--color-text-base)">Admin Panel</span>
        <button
      ...
      >
        ...
        <div class="flex items-center gap-2">
          <span
            ...
            style="background-color: color-mix(in srgb, #ef4444 20%, transparent); color: #f87171"
          >Admin</span>
...
const NAV = [
  ...
  { to: '/admin/gamification',  icon: '🏆', label: 'Gamification' },
  { to: '/admin/notifications', icon: '🔔', label: 'Thông báo' },
  { to: '/admin/audit-log',     icon: '📋', label: 'Nhật ký' },
