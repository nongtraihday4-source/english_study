...
# =============================================================================
# SPEECH-TO-TEXT SETTINGS (Phase 5)
# =============================================================================

# Enable/disable STT (False = use mock mode for development)
USE_SPEECH_TO_TEXT = config('USE_SPEECH_TO_TEXT', default=False, cast=bool)

# STT Provider: 'google', 'azure', 'assemblyai', 'mock'
STT_PROVIDER = config('STT_PROVIDER', default='mock')

# Google Cloud Speech-to-Text
GOOGLE_APPLICATION_CREDENTIALS = config('GOOGLE_APPLICATION_CREDENTIALS', default='')

# Azure Speech Service (future)
