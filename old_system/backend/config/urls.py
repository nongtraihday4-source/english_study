...
urlpatterns = [
    ...
    path('api/v1/grammar-analysis/', include('apps.grammar.urls', namespace='grammar')),
    ...
    # Direct access to main HTML pages (for convenience)
    path('flashcard-study.html', lambda request: serve_frontend(request, 'flashcard-study.html'), name='flashcard_study'),
    path('progress-dashboard.html', lambda request: serve_frontend(request, 'progress-dashboard.html'), name='progress_dashboard'),
    path('achievements.html', lambda request: serve_frontend(request, 'achievements.html'), name='achievements'),
    path('flashcard.html', lambda request: serve_frontend(request, 'flashcard.html'), name='flashcard'),
    path('dashboard.html', lambda request: serve_frontend(request, 'dashboard.html'), name='dashboard'),
    path('favicon.ico', lambda request: serve_frontend(request, 'favicon.ico'), name='favicon'),
]
